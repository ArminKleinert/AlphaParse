...
public final class InstaFailure implements InstaIntermediateResult, InstaParseResult {
    ...
    public InstaFailure(final int index, final @NotNull List<InstaFailureReason> reason) {
    ...
    public boolean equals(final Object o) {
        ...
        InstaFailure that = (InstaFailure) o;
