...
public final class OrderedCombinator extends Combinator {
    ...
    public void parse(final int index, final @NotNull InstaTramp tramp) {
        ...
        final @NotNull InstaNodeKey nodeKeyForComb1 = new InstaNodeKey(index, combinator1);
        final @NotNull InstaNodeKey nodeKeyForComb2 = new InstaNodeKey(index, combinator2);
        final @NotNull Listener listener = GllParserListeners.nodeListener(new InstaNodeKey(index, this), tramp);
