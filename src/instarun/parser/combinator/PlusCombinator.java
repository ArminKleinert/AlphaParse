...
public final class PlusCombinator extends CombinatorWithParser {
    ...
    public void parse(final int index, final @NotNull InstaTramp tramp) {
        ...
        Gll.pushListener(
                tramp, new InstaNodeKey(index, parser),
                GllParserListeners.plusListener(AutoFlattenSeq.make(), parser, index, new InstaNodeKey(index, this), tramp)
        );
    }
    ...
    public void fullParse(final int index, final @NotNull InstaTramp tramp) {
        ...
        Gll.pushListener(
                tramp, new InstaNodeKey(index, parser),
                GllParserListeners.plusFullListener(AutoFlattenSeq.make(), parser, index, new InstaNodeKey(index, this), tramp)
        );
    }
