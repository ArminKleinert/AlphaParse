...
public final class RepetitionCombinator extends CombinatorWithParser {
    ...
    public void parse(final int index, final @NotNull InstaTramp tramp) {
        ...
        final @NotNull InstaNodeKey parserNodeKey = new InstaNodeKey(index, this);
        final @NotNull InstaNodeKey combinatorNodeKey = new InstaNodeKey(index, combinator);
        if (getMin() == 0) {
    ...
    public void fullParse(final int index, final @NotNull InstaTramp tramp) {
        ...
        final int m = getMin();
        final int n = getMax();
        final @NotNull InstaNodeKey nodeKeyForParser = new InstaNodeKey(index, parser);
        final @NotNull InstaNodeKey nodeKeyForThis = new InstaNodeKey(index, this);
