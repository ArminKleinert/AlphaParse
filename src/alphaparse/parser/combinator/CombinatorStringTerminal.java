...
public class CombinatorStringTerminal extends CombinatorTerminal {
    ...
    public CombinatorStringTerminal(final @NotNull String string, final boolean caseInsensitive) {
        super();
        this.string = string;
        this.caseInsensitive = caseInsensitive;
    }

    public CombinatorStringTerminal(final boolean hide, final @NotNull ReductionType red, final @NotNull String string, final boolean caseInsensitive) {
        super(hide, red);
        this.string = string;
        this.caseInsensitive = caseInsensitive;
    }
    ...
    @Override
    public @NotNull CombinatorStringTerminal withHideTag(final boolean hide1) {
        return isHidden() == hide1 ? this : new CombinatorStringTerminal(hide1, this.getReduction(), getString(), caseInsensitive);
    }

    @Override
    public @NotNull CombinatorStringTerminal withReduction(final @NotNull ReductionType red1) {
        return getReduction() == red1 ? this : new CombinatorStringTerminal(isHidden(), red1, getString(), caseInsensitive);
    }
}
