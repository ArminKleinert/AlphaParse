...
//        if (!(tag instanceof String keyTag)) throw new IllegalArgumentException();
...
//        }
//
//        final var tag = m.get("tag");
//        final var content = m.get("content");
//
//        if (!(tag instanceof String && content instanceof List<?>))
//            throw new IllegalArgumentException();
//
...
//        if (!(Objects.equals(reductionType.getReductionType(), ReductionType.ReductionTypesAvailable.INITIAL)))
...
//     * @return A map.
//     */
//    public static @NotNull Map<String, Object> parserToMap(final @NotNull Parser parser) {
//        final @NotNull Function<Combinator, String> classTagLookup = (combinator1) ->
//                switch (combinator1) {
//                    case ChoiceCombinator ignored -> "alt";
//                    case ConcatCombinator ignored -> "cat";
...
//        );
//        return Map.of("start", start, "grammar", grammar);
//    }
}
